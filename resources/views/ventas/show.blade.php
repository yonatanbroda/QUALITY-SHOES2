    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <div>
                <div class="col">
                    <div>
                        <h2 class="font-weight-bold px-2">DETALLES DE COMPRA</h2>
                    </div>
                        ...
                        <div class="form-group col-md-6">
                            @foreach ($user as $users)
                                @if ($notaventa->id_vendedor == $users->id)
                                    <h5 class="font-weight-bold px-2">VENDEDOR: {{ $users->name }}</h5>
                                @endif
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="form-row row border">
                        <h5 class="font-weight-bold px-2">COMPRA TOTAL: {{ $notaventa->monto_total }} bs</h5>
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-striped table-bordered shadow-lg mt-4" id="ventas">
                                <thead
                                    ...
                                    <tr>
                                        <th class="font-weight-bold px-2">CANTIDAD</th>
                                        <th class="font-weight-bold px-2">CODIGO PRODUCTO</th>
                                        <th class="font-weight-bold px-2">COLOR</th>
                                        <th class="font-weight-bold px-2">PRECIO UNITARIO</th>
                                        <th class="font-weight-bold px-2">DESCRIPCION</th>
                                        <th class="font-weight-bold px-2">MARCA</th>
                                        <th class="font-weight-bold px-2">DESCUENTO</th>
                                        <th class="font-weight-bold px-2">TALLA</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
